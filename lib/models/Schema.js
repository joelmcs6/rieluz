...
import { mapValues, cloneDeep, map, isEmpty } from 'lodash-es';
...
class Schema {
  constructor(structure) {
    ...
    this.validator = SchemaValidator(mapValues(cloneDeep(this.structure), (field) => {
      delete field['index'];
      ...
      if (fieldType === undefined) {
        throw new GraphError(
          'VERTEX_SCHEMA_ERROR',
          'Invalid field type',
          { errors: [`Type ${field['type']} is not supported by rieluz`]}
        );
      }
